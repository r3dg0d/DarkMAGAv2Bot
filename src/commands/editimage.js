    ...
    async execute(interaction, bot) {
        ...
        if (!usageCheck.canUse) {
            if (usageCheck.reason === 'Demo limit reached') {
                ...
                const limitEmbed = demoUtils.createDemoLimitEmbed('editimage', demoUsage.used, demoUsage.max);
                const upgradePrompt = demoUtils.createUpgradePrompt('editimage');
                ...
                const paymentEmbed = paymentUtils.createPaymentPrompt('editimage');
        ...
        try {
            ...
            if (usageCheck.isDemo) {
                await demoUtils.useDemoCommand(interaction.user.id, interaction.guild.id, 'editimage');
