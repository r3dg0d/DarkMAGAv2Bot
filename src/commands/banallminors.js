...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const founderRoleId = '1375329828177444896';
        const founderRole = interaction.guild.roles.cache.get(founderRoleId);
        
        if (!founderRole || !interaction.member.roles.cache.has(founderRoleId)) {
            return interaction.reply({ 
                content: '❌ This command can only be used by users with the founder role.', 
                ephemeral: true 
            });
        }
