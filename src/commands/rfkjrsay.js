    ...
    async execute(interaction, bot) {
        ...
        if (!usageCheck.canUse) {
            if (usageCheck.reason === 'Demo limit reached') {
                ...
                const limitEmbed = demoUtils.createDemoLimitEmbed('rfkjrsay', demoUsage.used, demoUsage.max);
                const upgradePrompt = demoUtils.createUpgradePrompt('rfkjrsay');
                ...
                const paymentEmbed = paymentUtils.createPaymentPrompt('rfkjrsay');
        ...
        try {
            ...
            if (usageCheck.isDemo) {
                await demoUtils.useDemoCommand(interaction.user.id, interaction.guild.id, 'rfkjrsay');
