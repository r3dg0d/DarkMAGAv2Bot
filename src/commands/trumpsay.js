    ...
    async execute(interaction, bot) {
        ...
        if (!usageCheck.canUse) {
            if (usageCheck.reason === 'Demo limit reached') {
                ...
                const limitEmbed = demoUtils.createDemoLimitEmbed('trumpsay', demoUsage.used, demoUsage.max);
                const upgradePrompt = demoUtils.createUpgradePrompt('trumpsay');
                ...
                const paymentEmbed = paymentUtils.createPaymentPrompt('trumpsay');
        ...
        try {
            ...
            if (usageCheck.isDemo) {
                await demoUtils.useDemoCommand(interaction.user.id, interaction.guild.id, 'trumpsay');
                ...
                try {
                    ...
                    if (videoResult.data?.video?.url) {
                        ...
                        const videoEmbed = new EmbedBuilder()
                            ...
                            .setFooter({ text: 'Powered by fal.ai veed/fabric-1.0 | Make America Great Again!', iconURL: 'https://registry.npmmirror.com/@lobehub/icons-static-png/1.68.0/files/dark/fal-color.png' })
                            .setTimestamp();
