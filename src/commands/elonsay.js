    ...
    async execute(interaction, bot) {
        ...
        if (!usageCheck.canUse) {
            if (usageCheck.reason === 'Demo limit reached') {
                ...
                const limitEmbed = demoUtils.createDemoLimitEmbed('elonsay', demoUsage.used, demoUsage.max);
                const upgradePrompt = demoUtils.createUpgradePrompt('elonsay');
                ...
                const paymentEmbed = paymentUtils.createPaymentPrompt('elonsay');
        ...
        try {
            ...
            if (usageCheck.isDemo) {
                await demoUtils.useDemoCommand(interaction.user.id, interaction.guild.id, 'elonsay');
