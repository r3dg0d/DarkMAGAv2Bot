    ...
    async execute(interaction, bot) {
        ...
        if (!usageCheck.canUse) {
            if (usageCheck.reason === 'Demo limit reached') {
                ...
                const limitEmbed = demoUtils.createDemoLimitEmbed('samaltmansay', demoUsage.used, demoUsage.max);
                const upgradePrompt = demoUtils.createUpgradePrompt('samaltmansay');
                ...
                const paymentEmbed = paymentUtils.createPaymentPrompt('samaltmansay');
        ...
        try {
            ...
            if (usageCheck.isDemo) {
                await demoUtils.useDemoCommand(interaction.user.id, interaction.guild.id, 'samaltmansay');
