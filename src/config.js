module.exports = {
    ...
    roles: {
        ...
        serverBooster: '1372657548150181942' // Server Booster role ID
    },
    ...
    uncensoredApiKey: process.env.UNCENSORED_API_KEY,
    uncensoredApiUrl: 'https://mkstqjtsujvcaobdksxs.functions.supabase.co/functions/v1/uncensoredlm-api',
